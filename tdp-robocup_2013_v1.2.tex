...
%%
\institute{Laborat{\'o}rio de T{\'e}cnicas Inteligentes - EP/USP\\
           Av. Prof. Luciano Gualberto, 158 -- trav. 3\\
           05508-970 -- S{\~a}o Paulo -- SP -- Brasil\\
\email{\{alan.barroso, fesantana, victor.lassance, annibal.silva, \\
			 luis.nardin, anarosa.brandao, jaime.sichman\}@usp.br}
}
%%
\maketitle
%%
