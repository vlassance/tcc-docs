%%
The solution we propose to the problem of map exploration is the partitioning of the map into sectors, in which each Police Force is assigned to patrol one of the sectors. Police Forces are the obvious choice to explore the map because they have the ability to remove blockades, granting access to any place in the map. Additionally, division of Police Forces in sectors ceases their encounters reducing the number of idle agents.
